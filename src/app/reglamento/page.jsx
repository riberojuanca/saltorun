...
function rules() {
  return (
    <main className=" font-light p-4 text-zinc-200 flex flex-col gap-4 ms-auto me-auto max-w-4xl text-lg">
      <h1 className="mt-10 font-semibold text-5xl">REGLAMENTO</h1>
      <h2 className="mt-10 font-medium text-2xl">ORGANIZADORES:</h2>
      <p>
      ...
      <h2 className="mt-10 font-medium text-2xl">JUECES:</h2>
      <p>
      ...
      <ul className=" px-4 font-medium text-xl">
        <li>JUEZ 1 – Titular: Richard Nessi</li>
        <li>JUEZ 2 – Titular: Martin Peralta</li>
      </ul>
      <h2 className=" mt-10 font-medium text-2xl">FORMATO DEL CAMPEONATO:</h2>
      <p>
      ...
      <h2 className=" mt-10 font-medium text-2xl">Puntajes por categoría:</h2>
      {/* <ul>
        <li>1º = 30 puntos</li>
        <li>2º = 26 puntos</li>
        <li>3º = 23 puntos</li>
      ...
      <h2 className=" mt-10 font-medium text-2xl">Premiación</h2>
      <p>
      ...
      <h3 className=" mt-4 font-medium text-xl">También se premiará:</h3>
      <ol className="px-4">
        <li>
      ...
      <h2 className=" mt-10 font-medium text-2xl">INSCRIPCIÓN</h2>
      <p>
      ...
      <h2 className=" mt-10 font-medium text-2xl">RETIRO DE NÚMEROS:</h2>
      <p>
      ...
      <h2 className=" mt-10 font-medium text-2xl">COSTO:</h2>
      <p>
      ...
      <h2 className=" mt-10 font-medium text-2xl">FORMA DE PAGO:</h2>
      <p>
      ...
      <h2 className=" mt-10 font-medium text-2xl">SUSPENSIÓN:</h2>
      <p>
      ...
      <h2 className=" mt-10 font-medium text-2xl">SORTEOS:</h2>
      <p>
      ...
      <h2 className=" mt-10 font-medium text-2xl">NÚMERO DE COMPETIDOR:</h2>
      ...
      <h2 className=" mt-10 font-medium text-2xl">REGLAMENTO DE CARRERA:</h2>
      <h3 className=" mt-4 font-medium text-xl">Largada:</h3>
      <p>
      ...
      <h3 className=" mt-4 font-medium text-xl">Desarrollo de la prueba:</h3>
      <p>
      ...
      <h3 className=" mt-4 font-medium text-xl">Llegada:</h3>
      <p>
