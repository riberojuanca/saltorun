...
async function PrimerFecha() {
  const csv = await fetch(
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vQHIVIyd99OiQ6xrmNGc2OBYfHxTDD7IAZOkd4uj-Lg23Vm8DlMjI8c0Q8i7sDspjjgtP4IwbMj3B1-/pub?output=tsv"
  ).then((res) => res.text());

  const primerFecha = csv
    .split("\n")
    .slice(1)
    .map((row) => {
  ...
  primerFecha.sort((a, b) => b.totalPoints - a.totalPoints);
