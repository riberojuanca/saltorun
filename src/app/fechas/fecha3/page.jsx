...
async function TerceraFecha() {
  const csv = await fetch(
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vTUVC3qIxYBmgdGnbtTAuGfclK5JX85z0AAFY-vZilENxr9_OS_ZYv_teB0UfPHb9lAkeWEQr_Z0jpX/pub?output=tsv"
  ).then((res) => res.text());

  const terceraFecha = csv
    .split("\n")
    .slice(1)
    .map((row) => {
  ...
  terceraFecha.sort((a, b) => b.totalPoints - a.totalPoints);
